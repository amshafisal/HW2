...
#answer ex3
The ratio of the values ​​in the chart are equal between each other, but varying in terms of data in the sense of physics, which is the first in NA, USA, Other
```{r}
